...
declare -a set_iterator=(
	...
	"crash_operator-val operator_it-val.cpp srcs/set_iterator/crash_test/"
	"crash_operator-it operator_it-it.cpp srcs/set_iterator/crash_test/"
	"crash_operator< operator_inf.cpp srcs/set_iterator/crash_test/"
	"crash_operator> operator_sup.cpp srcs/set_iterator/crash_test/"
	"crash_operator<= operator_infeq.cpp srcs/set_iterator/crash_test/"
	"crash_operator>= operator_supeq.cpp srcs/set_iterator/crash_test/"
	"crash_operator+= operator_it+=val.cpp srcs/set_iterator/crash_test/"
	"crash_operator-= operator_it-=val.cpp srcs/set_iterator/crash_test/"
	"crash_operator[] operator[].cpp srcs/set_iterator/crash_test/"
	)
